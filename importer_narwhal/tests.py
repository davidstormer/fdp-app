...
from supporting.models import PersonIdentifierType, PersonRelationshipType, SituationRole, ContentType, TraitType, \
    ...
    AllegationOutcome, Allegation, Trait, Title, County, LeaveStatus, State, PersonGroupingType, \
    GroupingRelationshipType, AttachmentType, Trait, Title, County, LeaveStatus, State, PersonGroupingType, \
    GroupingRelationshipType, AttachmentType
